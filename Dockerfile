...
RUN apt-get install -y libapache2-mod-php7.0 php7.0-common php7.0-pgsql  php7.0-curl php7.0-json php7.0-cgi php7.0-gd php-amqplib php7.0-bcmath &&  pecl install imagick && docker-php-ext-enable imagick && rm -rf /var/lib/apt/lists/*
VOLUME ["/var/www/app"]
